...
var fs      = require('fs');
var gotta		= require('./gottacatchemoji.js');
...
var SampleApp = function() {
    ...
    self.setupVariables = function() {
        ...
        self.ipaddress = "127.0.0.1"; //"168.235.79.118";
        self.port      = 8081;
    ...
    self.createRoutes = function() {
        ...
        self.routes['/'] = function(req, res) {
					gotta.generateSite(function(result) {
						res.send(result);
					});
        };

        self.routes['/catchemoji'] = function(req, res) {
					gotta.generateSite(function(result) {
						res.send(result);
					});
        };

				self.routes['/catchemoji/static/:folder/:file'] = function(req, res) {
          ...
          res.setHeader('Content-Type', 'text/css');
					res.send(fs.readFileSync('./static/css/' + req.params.file));
				};
    };
